...
- generic [ref=f1e1]:
  ...
  - iframe [active] [ref=f1e311]:
    - generic [ref=f2e1]:
      ...
      - generic [ref=f2e6]:
        - generic [ref=f2e12]:
          - 'heading "PIM : Add Employee" [level=2] [ref=f2e14]'
          - generic [ref=f2e15]: Code
          - textbox "Code" [ref=f2e16]: "15715"
          - generic [ref=f2e17]: Last Name *
          - textbox "Last Name *" [ref=f2e18]: punekar
          - generic [ref=f2e19]: First Name *
          - textbox [ref=f2e20]: Kanchan
          - generic [ref=f2e21]: Middle Name
          - textbox "Middle Name" [ref=f2e22]
          - generic [ref=f2e23]: Nick Name
          - textbox "Nick Name" [ref=f2e24]
          - generic [ref=f2e25]: Photo
          - button "Photo" [ref=f2e26]
          - generic [ref=f2e27]:
            - button "Save" [active] [ref=f2e28]
            - button "Reset" [ref=f2e29]
        - generic [ref=f2e34]: Fields marked with an asterisk * are required.
